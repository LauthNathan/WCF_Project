...
namespace WCF_Middleware.JEEService {
    ...
    public interface IFileWebService {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(WCF_Middleware.JEEService.JMSException), Action="http://services.recive.cesi.com/IFileWebService/fileCheck/Fault/JMSException", Name="JMSException")]
        ...
        WCF_Middleware.JEEService.fileCheckResponse1 fileCheck(WCF_Middleware.JEEService.fileCheckRequest request);
    }
    ...
    public partial class fileCheckRequest {
        ...
        public WCF_Middleware.JEEService.msg msg;
        
        public fileCheckRequest() {
        }
        
        public fileCheckRequest(WCF_Middleware.JEEService.msg msg) {
            this.msg = msg;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IFileWebServiceChannel : WCF_Middleware.JEEService.IFileWebService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class FileWebServiceClient : System.ServiceModel.ClientBase<WCF_Middleware.JEEService.IFileWebService>, WCF_Middleware.JEEService.IFileWebService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        WCF_Middleware.JEEService.fileCheckResponse1 WCF_Middleware.JEEService.IFileWebService.fileCheck(WCF_Middleware.JEEService.fileCheckRequest request) {
            return base.Channel.fileCheck(request);
        }
        
        public string fileCheck(WCF_Middleware.JEEService.msg msg) {
            WCF_Middleware.JEEService.fileCheckRequest inValue = new WCF_Middleware.JEEService.fileCheckRequest();
            inValue.msg = msg;
            WCF_Middleware.JEEService.fileCheckResponse1 retVal = ((WCF_Middleware.JEEService.IFileWebService)(this)).fileCheck(inValue);
